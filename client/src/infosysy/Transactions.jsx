...
const navigate=useNavigate()
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            accountNumber: Yup.string()
            .test('valid-account', 'Account Number must be exactly 16 digits', (value) => {
    ...
    const handleAccountNumberChange = (e) => {
        ...
        formik.setFieldValue('accountNumber', formattedValue);
      };
    ...
    const currenttrans= transactions.slice(indexOfFirstGoal, indexOfLastGoal);
    ...
    const totalPages = Math.ceil(transactions.length / goalsPerPage);
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    type="text"
                                    id="accountNumber"
                                    {...formik.getFieldProps('accountNumber')}onChange={handleAccountNumberChange}
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    type="date"
                                    id="date"
                                    {...formik.getFieldProps('date')}max={new Date().toISOString().split('T')[0]} 
