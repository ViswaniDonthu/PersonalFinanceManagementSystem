...
public class TransactionServiceImp implements TransactionService {
    ...
    public Transaction saveTransaction(Transaction transaction) {
       ...
       System.out.println(t.getRegister().getId()+t.getGoal());
       int g=0;
       if(t.getTransactionType().equals("debit")) {
           g = goalRepository.updateProgresstargetByRegister_IdAndGoalName(t.getRegister().getId(), t.getGoal(),t.getAmount());
       }
       else if(t.getTransactionType().equals("credit")) {
            g=goalRepository.updateProgresstargetByRegister_IdAndGoalName(t.getRegister().getId(), t.getGoal(),-t.getAmount());
       }
         System.out.println("updated goal successfully  "+g);
        return t;
    }
